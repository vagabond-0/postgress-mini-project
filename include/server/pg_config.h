...
#define CONFIGURE_ARGS " '--prefix=/home/amalendu/project/postgresql-17.4' '--enable-cassert' '--enable-debug' '--without-icu'"
...
#define PG_VERSION_STR "PostgreSQL 17.4 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 14.2.1 20250128, 64-bit"
